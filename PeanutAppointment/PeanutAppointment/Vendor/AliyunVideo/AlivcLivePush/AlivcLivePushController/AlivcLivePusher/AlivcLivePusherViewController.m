...
- (void)viewDidAppear:(BOOL)animated{
    ...
    AlivcPushBeautyParams *params = [self getBeautyParamsOfLevel:[self getBeautyLevel]];
...
- (AlivcPushBeautyParamsLevel)getBeautyLevel{
    ...
    if(beautyLevel){
        AlivcPushBeautyParamsLevel level = [[[NSUserDefaults standardUserDefaults] objectForKey:@"beautyLevel"] integerValue];
        return level;
    }
    return [AlivcPushBeautyParams defaultBeautyLevel];
}
...
- (AlivcPushBeautyParams *)getBeautyParamsOfLevel:(AlivcPushBeautyParamsLevel)level{
    ...
    if (!beautyWhiteStr) { //说明还没有存储过，取默认值
        parames = [AlivcPushBeautyParams defaultBeautyParamsWithLevel:level];
...
- (NSArray<NSDictionary *> *)beautyDetailItems{
    AlivcPushBeautyParamsLevel level = [self getBeautyLevel];
    AlivcPushBeautyParams *params = [self getBeautyParamsOfLevel:level];
    AlivcPushBeautyParams *defaultParams = [AlivcPushBeautyParams defaultBeautyParamsWithLevel:level];
