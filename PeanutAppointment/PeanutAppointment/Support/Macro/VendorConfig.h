...
#pragma mark - AppleAppId -
static NSString * const AppleAppId = @"1240719357";

#pragma mark - JPush -
static NSString * const JPushAppKey = @"924ee42aa48623fa941b1620";

#pragma mark - 又拍云 -
static NSString * const UpYunSpaceName = @"imagexb";
static NSString * const UpYunOprater = @"xbtiangou";
static NSString * const UpYunPassword = @"xbtiangou";
static NSString * const UpYunURL = @"http://imagexb.test.upcdn.net";
static NSString * const UpYunUserPic = @"/xbsc/user/";
static NSString * const UpYunStorePic = @"/xbsc/store/";

#pragma mark - 微信 -
static NSString * const WeChatAppId = @"wx3b113565e7197660";
