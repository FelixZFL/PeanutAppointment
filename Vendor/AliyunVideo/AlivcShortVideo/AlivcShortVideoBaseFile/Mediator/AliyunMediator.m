...
//    Class c = NSClassFromString(@"AliyunCompositionViewController");
    UIViewController *vc = (UIViewController *)[[AliyunCompositionViewController alloc] init];
    return vc;
}
...
//    Class c = NSClassFromString(@"AliyunRecordViewController");
    UIViewController *vc = (UIViewController *)[[AliyunRecordViewController alloc] init];
    return vc;
}
