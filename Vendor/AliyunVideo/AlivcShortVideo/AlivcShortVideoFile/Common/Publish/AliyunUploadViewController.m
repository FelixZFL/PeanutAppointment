...
- (void)viewDidLoad {
    ...
    [YQNetworking postWithApiNumber:API_NUM_20023 params:@{@"type":@"1"} successBlock:^(id response) {
        if (getResponseIsSuccess(response)) {
            ...
            [[AliyunPublishService service] uploadWithImagePath:self.coverImagePath svideoInfo:info accessKeyId:model.accessKeyId accessKeySecret:model.accessKeySecret accessToken:model.securityToken];
        }
